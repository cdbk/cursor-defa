...
## [RULES] 適用ルール
- **主要ルール**: [frontend/backend/testing/error_handling/team_collaboration/knowledge_management/core]
...
- **最適化後**: 
  ...
  - `knowledge_management_rules.cursorrules` (新規追加) - SECIモデル統合・暗黙知自動ルール化
- **総行数**: 約900行（統合機能強化）
